          ...
          <div className="flex items-center gap-6 mt-3">
            ...
            >
              <div className="p-1.5 rounded-full group-hover:bg-[#00ba7c]/10 transition-colors">
                <svg
                  className="w-4 h-4 text-[#71767b] group-hover:text-[#00ba7c]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
            ...
            >
              <div className="p-1.5 rounded-full group-hover:bg-[#f91880]/10 transition-colors">
                <svg
                  className="w-4 h-4 text-[#71767b] group-hover:text-[#f91880]"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
            ...
            <button onClick={handleBookmark} className="flex items-center gap-2 group">
              ...
              >
                <svg
                  className={`w-4 h-4 ${bookmarked ? 'text-[#1d9bf0]' : 'text-[#71767b] group-hover:text-[#1d9bf0]'}`}
                  viewBox="0 0 24 24"
