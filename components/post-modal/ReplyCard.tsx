      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1 text-[15px]">
            ...
            <span className="text-[--text-muted]">@{reply.author?.username}</span>
            <span className="text-[--text-muted]">·</span>
            <span className="text-[--text-muted]">{formatTime(reply.created_at)}</span>
            {reply.metadata?.confidence !== undefined && (
              <span className="text-[--text-muted]" title="Confidence score">
