  ...
  return (
    <div className="flex items-center justify-between mt-3 max-w-[425px]" onClick={(e) => e.stopPropagation()}>
      ...
      <button className="flex items-center gap-2 group">
        ...
        <span className="text-[13px] text-[#71767b] group-hover:text-[#1d9bf0]">{replyCount > 0 ? formatCount(replyCount) : ''}</span>
      </button>
      ...
      <div className="flex items-center gap-2 group">
        ...
        <span className="text-[13px] text-[#71767b]">{repostCount > 0 ? formatCount(repostCount) : ''}</span>
      </div>
      ...
      <div className="flex items-center gap-2 group">
        ...
        <span className="text-[13px] text-[#71767b]">{likeCount > 0 ? formatCount(likeCount) : ''}</span>
      </div>
