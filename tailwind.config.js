  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'glow-sunset': 'radial-gradient(ellipse 80% 50% at 50% -20%, rgba(255, 100, 80, 0.15), transparent)',
        'glow-subtle': 'radial-gradient(ellipse at top center, rgba(255, 107, 91, 0.08) 0%, transparent 60%)',
      },
      boxShadow: {
